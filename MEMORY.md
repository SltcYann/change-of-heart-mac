...
- 2026-08-26: Public README fully rewritten for the macOS edition — Apple Silicon `arm64` status, compatibility matrix, build/run steps, save discovery, architecture, Gatekeeper guidance, limitations, safety and credits.
